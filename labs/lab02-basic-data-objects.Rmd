---
title: "Lab 2: Basic Data Objects"
...
Without running the code, try to guess the output of the following commands, and then run them to check your guess:
...
As we saw in lecture, a vector can be extended into a 2-dimensional object in the form of a __matrix__ (which is a 2-dimensional array).
