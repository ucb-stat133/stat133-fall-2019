---
title: "Lab 4: Importing Tables and Intro to ggplot2"
...
The first part of the lab involves importing the __Abalone Data Set__ 
that is part of the
...
file directly to any of the `read.table()` functions. Here's an example using `read.table()` in an extremely default way:
...
I'm assuming that you already installed the package `"ggplot2"`. 
...
- Find out how to make another scatterplot like the previous one, but now 
